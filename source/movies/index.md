...
{% note warning %}
电影院正在建设中，影视资源整理开发，敬请期待！
{% endnote %}

<div style="height:60vh;display:flex;flex-direction:column;justify-content:center;align-items:center;">
  <i class="fas fa-film" style="font-size:64px;opacity:0.5;"></i>
  <h2 style="margin:24px 0 12px 0;font-weight:500;">电影院 · 建设中</h2>
  <p style="opacity:0.6;">正在整理影视资料，敬请期待</p>
